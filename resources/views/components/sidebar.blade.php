<aside class="flex-auto h-full bg-indigo-500" aria-label="Sidebar">
    <div class="overflow-y-auto bg-indigo-500">
        <ul class="space-y-2 text-white">
            ...
            <li>
                <a href="{{ route('service_orders.index') }}" class="flex items-center py-5 px-4 text-lg font-normal hover:bg-indigo-400">
